        ...
        button_with_repetition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(maxEditText.getText().toString())
                    ...
                    Toast.makeText(code.this, "Enter Inputs", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    if (range_num <= max_num) {
                        ...
                        Toast.makeText(code.this, "The range should be lower than the max number", Toast.LENGTH_LONG).show();
                    }
